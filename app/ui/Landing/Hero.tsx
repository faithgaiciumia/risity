...
export default async function Hero() {
  ...
  return (
    <section className="flex flex-col items-center justify-center text-center px-4 py-20 md:py-32 gap-6 bg-white">
      ...
      <h1
        className={`text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 ${poppins.className} max-w-2xl`}
      >
        Your ultimate invoice partner for business
      </h1>

      <h2
        className={`text-base md:text-lg text-gray-600 max-w-xl ${workSans.className}`}
      >
